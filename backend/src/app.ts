...
import { RoutesEdge } from "./routes/v1/RoutesEdge";
import { RoutesReactFlow } from "./routes/v1/RoutesReactFlow";
const app = express();
...
app.use('/v1', IsAuthenticated, RoutesReactFlow)
...
app.use('/v1', IsAuthenticated, RoutesEdge)
